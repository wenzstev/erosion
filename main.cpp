...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<Application> app = std::make_unique<Application>(std::move(appConfig), std::move(window), std::move(renderer), std::move(shader), std::move(meshGenerator));
